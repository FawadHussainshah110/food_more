...
// Padding
EdgeInsets paddingExtraSmall = EdgeInsets.all(4.sp);
...
double spacingHuge = 40.sp;
double spacingExtraHuge = 56.sp;

double get radiusSmall => 8.sp;
double get radiusDefault => 12.sp;
double get radiuslarge => 15.sp;
...
TextStyle fontAudioWide(BuildContext context) => GoogleFonts.audiowide(textStyle: Theme.of(context).textTheme.titleSmall);
TextStyle fontArizonia(BuildContext context) => GoogleFonts.arizonia(textStyle: Theme.of(context).textTheme.titleSmall);
